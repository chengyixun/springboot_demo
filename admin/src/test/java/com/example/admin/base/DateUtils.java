...
/** @ClassName: DateUtil @Author: amy @Description: 日期格式 @Date: 2021/5/28 @Version: 1.0 */
@Slf4j
public class DateUtils {
  ...
  public static LocalDate toLocalDate(String dateTime) {
    return Instant.ofEpochMilli(parseDate(dateTime).getTime())
  ...
  public static List<String> getDates(String startDate, String endDate) {
    ...
    while (startLocalDate.compareTo(endLocalDate) <= 0) {
      dates.add(format(startLocalDate));
