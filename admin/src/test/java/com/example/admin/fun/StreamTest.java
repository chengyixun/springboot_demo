...
import com.example.admin.base.DateUtils;
import com.example.admin.fun.entity.LaborDemandVO;
import com.example.admin.fun.entity.ShiftNumVO;
...
public class StreamTest {
  ...
  public List<ShiftNumVO> getShifts() {

    List<String> dates = DateUtils.getDates("2022-01-10", "2022-01-16");
    return dates.stream()
        .map(m -> ShiftNumVO.of(m, Long.valueOf(DateUtils.getDayOfMonth(m))))
        .collect(Collectors.toList());
  }
  ...
  @Test
  public void test92() {
    List<LaborDemandVO> laborDemands = Lists.newArrayList();
    for (int i = 1; i < 5; i++) {
      Long productionLineId = Long.valueOf(i);
      Long workSectionId = productionLineId * 10 + productionLineId;
      Long postId = productionLineId * 100 + workSectionId;
      laborDemands.add(
