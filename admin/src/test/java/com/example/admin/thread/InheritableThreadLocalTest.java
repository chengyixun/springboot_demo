 ...
 *
 *             <p>
 *             InheritableThreadLocal 线程共享了 其他子线程再获取的时候 值会变掉 demo演示 error
 */
@Slf4j
public class InheritableThreadLocalTest implements Runnable {
	...
	private static ThreadPoolExecutor tpe = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS,
...
/**
 * 主线程启动 主线程:main, 主线程设置后获取值：主线程第一次赋值 主线程:main,sleep 2 s
 * 子线程:pool-1-thread-1,子线程获取值:主线程第一次赋值 子线程:pool-1-thread-1,子线程获取值:主线程第一次赋值
 */
