...
/**
 * @ClassName: TestThreadLocal @Author: amy @Description: TestThreadLocal @Date: 2021/12/7 @Version:
 * 1.0
 *
 * <p>验证ThreadLocal 线程间隔离 ，
 *
 * <p>main线程 设置的值，
 *
 * <p>T2线程 获取不到
...
public class TestThreadLocal implements Runnable {
  ...
  public void run() {
    log.info(
        "T:{},before set value, get current local value:{}",
