...
public enum TermEnum {
	eq("eq"), not("not"), like("like"), nlike("nlike"), gt("gt"), lt("lt"), gte("gte"), lte("lte"), in("in"),
	nin("nin"), empty("empty"), nempty("nempty"), isnull("isnull"), notnull("notnull"), btw("btw"), nbtw("nbtw"),
