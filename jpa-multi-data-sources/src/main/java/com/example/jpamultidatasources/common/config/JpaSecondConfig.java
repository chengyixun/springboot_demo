...
/**
 * @ClassName: JpaSecondConfig @Author: amy @Description: JpaSecondConfig @Date: 2021/9/18 @Version:
 * 1.0
 */
@Configuration
@EnableJpaRepositories(
    basePackages = "com.example.jpamultidatasources.dao2",
...
public class JpaSecondConfig {
  ...
  @Bean
  public PlatformTransactionManager platformTransactionManagerSecond(
      EntityManagerFactoryBuilder builder) {
    LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean =
        localContainerEntityManagerFactoryBeanSecond(builder);
