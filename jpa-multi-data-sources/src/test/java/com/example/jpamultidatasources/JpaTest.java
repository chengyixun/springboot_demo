...
/** @ClassName: JpaTest @Author: amy @Description: JpaTest @Date: 2021/9/18 @Version: 1.0 */
@SpringBootTest
@RunWith(SpringRunner.class)
public class JpaTest {
  @Autowired private BookFirstDao bookFirstDao;

  @Autowired private BookSecondDao bookSecondDao;
