...
/**
 * @ClassName: TokenService @Author: amy @Description: TokenService @Date: 2021/7/6 @Version: 1.0
 */
@Component
public class TokenService {
  ...
  private String doGenerateToken(LoginUser loginUser) {
    ...
    Claims claims =
        Jwts.claims().setSubject(loginUser.getUsername()).setAudience(loginUser.getTenant());
