...
/**
 * @ClassName: DataSourceBasedMultiTenantConnectionProviderImpl @Author:
 *             amy @Description: 提供租户标识对应的租户数据源信息
 *
 *             <p>
 *             通过查询租户数据源库，动态获得租户数据源信息，为租户业务模块的数据源配置提供数据数据支持。 @Date:
...
public class DataSourceBasedMultiTenantConnectionProviderImpl
	...
	private void loadDataSources() {
		...
		tenants.forEach(tenant -> dataSources.put(tenant.getTenant(), DataSourceUtils.wrapperDataSource(tenant)));
	}
}
