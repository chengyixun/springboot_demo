...
/**
 * @ClassName: UserServiceTest @Author: amy @Description: UserServiceTest @Date: 2021/5/25 @Version:
 * 1.0
 */
@SpringBootTest
...
public class DemoRepositoryTest {
  ...
  @Autowired private UserRecordRepository userRecordRepository;
  ...
  public void testDept1() {
    Department department =
        departmentRepository.findById(1L).orElseThrow(() -> Exceptions.NOT_FOUND());
