...
/**
 * @ClassName: MybatisConfig @Author: amy @Description: MybatisConfig @Date: 2021/10/10 @Version:
 * 1.0
 */
@Slf4j
@Configuration
...
public class MybatisConfig {
  ...
  /** 注入数据源相关的外部动态配置 */
  @Autowired private BaseDataSourceConfig baseDataSourceConfig;
  ...
  public DataSource dynamicDataSource() {
    ...
    Tenant tenant =
        Tenant.builder()
            ...
            .tenantId(BASE_DATASOURCE_KEY)
            .tenantName(BASE_DATASOURCE_NAME)
            .build();
