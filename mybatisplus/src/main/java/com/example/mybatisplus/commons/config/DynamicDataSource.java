...
/**
 * @ClassName: DynamicDataSource @Author: amy @Description: DynamicDataSource
 *             动态数据源实现类 @Date: 2021/10/11 @Version: 1.0
 */
@Slf4j
public class DynamicDataSource extends AbstractRoutingDataSource {

	/**
	 * 如果希望所有数据源在启动配置时就加载好，这里通过设置数据源Key值来切换数据，定制这个方法 可以根据上下文 获取当前租户标识
	 * 
	 * @return
	 */
	@Override
