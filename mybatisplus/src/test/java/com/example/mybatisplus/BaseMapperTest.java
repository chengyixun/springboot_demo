...
public class BaseMapperTest {
	...
	/*
	 * @Test public void insert() { User user =
	 * User.builder().username("www").password("123456").build(); int insert =
	 * userMapper.insert(user); log.info("插入影响行数:{},小华的ID：{}", insert,
	 * user.getId()); }
	 * 
	 *//** 根据ID更新 *//*
					 * @Test public void update() { User user =
					 * User.builder().username("张三111").build(); user.setId(22235L);
	...
	public void selectPage() {
		...
		log.info("总数：{},总页数：{},当前页：{},页大小：{}", result.getTotal(), result.getPages(), result.getCurrent(),
				result.getSize());
	}
	 ...
	 *
	 * <p>
	 * 可以用new ArrayList(Arrays.asList(arr))包一下的。
	 */
	@Test
	...
	public void testPageQuery() {
		...
		log.info("总记录数:{},总页数：{},当前页码：{}", employeePage.getTotal(), employeePage.getPages(), employeePage.getCurrent());
