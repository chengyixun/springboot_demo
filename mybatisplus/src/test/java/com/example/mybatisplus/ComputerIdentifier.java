...
public class ComputerIdentifier {
    public static void main(String[] args) {
        ...
        *//**
         * 上面的方法只能得到jvm的堆和非堆的整体数据，一般都知道堆和非堆里面都几个不同的区，用来做不同功能，
         * 那么如何得到不同区的数据呢？不多说，上代码
         *//*
    ...
    public static String generateLicenseKey() {
        ...
        return String.format(">>>manufacturer:[%s],systemSerialNumber:[%s],identifier:[%s],count:[%s]", manufacturer, systemSerialNumber, identifier, logicalProcessorCount);
