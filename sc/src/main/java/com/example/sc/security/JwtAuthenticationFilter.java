	...
	protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
		...
		if (header != null && header.startsWith(JWTConstants.TOKEN_PREFIX)) {
			...
			try {
				 ...
				 * masterTenantService.findByClientId(Integer.valueOf(audience)); if(null ==
				 * masterTenant){ logger.error("An error during getting tenant name"); throw new
				 * BadCredentialsException("Invalid tenant and user."); }
